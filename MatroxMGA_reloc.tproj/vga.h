...
extern Bool (*vgaBlankScreenFunc)(unsigned char *MGAMMIOBase, ScreenPtr pScreen,Bool On);
...
/* Blanks screen */
Bool vgaBlankScreen(unsigned char *MGAMMIOBase, ScreenPtr pScreen,Bool On);
